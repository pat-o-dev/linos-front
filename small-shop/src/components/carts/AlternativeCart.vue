<template>
      <section class="bg-base-100 py-8 antialiased md:py-16">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
        <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
          <div class="space-y-6">
            <div
              class="rounded-lg border border-base-200 bg-base-500 p-4 shadow-sm md:p-6"
            >
              <div
              ...
              >
                ...
                <div class="flex items-center justify-between md:order-3 md:justify-end">
                  <div class="flex items-center">
                    <button
                      ...
                      class="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-base-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 :bg-gray-600 :ring-gray-700"
                    >
                      <svg
                        class="h-2.5 w-2.5 "
                        aria-hidden="true"
                ...
                <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                  <a href="#" class="text-base font-medium hover:underline"
                    ...
                    Retina 4.5K, 8GB, SSD 256GB, 10-core GPU, Keyboard layout INT</a
                  >

                  <div class="flex items-center gap-4">
                    <button
                      type="button"
                      class="inline-flex items-center text-sm font-medium text-gray-500 hover hover:underline :text-white"
                    >
                      <svg
            ...
            <div class="rounded-lg border border-gray-200 bg-base p-4 shadow-sm md:p-6">
              <div
                class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0"
              >
                <a href="#" class="shrink-0 md:order-1">
                ...
                <div class="flex items-center justify-between md:order-3 md:justify-end">
                  ...
                  <div class="text-end md:order-4 md:w-32">
                    <p class="text-base font-bold">$598</p>
                  </div>
                </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-base p-4 shadow-sm md:p-6">
              ...
              >
                ...
                <div class="flex items-center justify-between md:order-3 md:justify-end">
                  ...
                  <div class="text-end md:order-4 md:w-32">
                    <p class="text-base font-bold ">$1,799</p>
                  </div>
                </div>

                <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                  <a href="#" class="text-base font-medium  hover:underline"
                    >Apple - MacBook Pro 16" Laptop, M3 Pro chip, 36GB Memory, 18-core
                    GPU, 512GB SSD, Space Black</a
                  >
            ...
            <div class="rounded-lg border border-gray-200 bg-base p-4 shadow-sm md:p-6">
              ...
              >
                ...
                <div class="flex items-center justify-between md:order-3 md:justify-end">
                  ...
                  <div class="text-end md:order-4 md:w-32">
                    <p class="text-base font-bold ">$699</p>
                  </div>
                </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-base p-4 shadow-sm md:p-6">
              ...
              >
                ...
                <div class="flex items-center justify-between md:order-3 md:justify-end">
                  ...
                  <div class="text-end md:order-4 md:w-32">
                    <p class="text-base font-bold ">$2,997</p>
                  </div>
                </div>
          ...
          <div class="hidden xl:mt-8 xl:block">
            ...
            <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
              <div
                class="space-y-6 overflow-hidden rounded-lg border border-gray-200 bg-base p-6 shadow-sm"
              >
                ...
                <div class="mt-6 flex items-center gap-2.5">
                  <button
                    ...
                    type="button"
                    class="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-base p-2.5 text-sm font-medium  hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 :bg-gray-700 :text-white :ring-gray-700"
                  >
                    <svg
                      class="h-5 w-5"
                      aria-hidden="true"
                  ...
                  <button
                    type="button"
                    class="inline-flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 :bg-primary-700 :ring-primary-800"
                  >
                    <svg
        ...
        <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
          <div
            class="space-y-4 rounded-lg border border-gray-200 bg-base p-4 shadow-sm sm:p-6"
          >
            ...
            <a
              href="#"
              class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 :bg-primary-700 :ring-primary-800"
          ...
          >
            <form class="space-y-4">
              <div>
                <label for="voucher" class="mb-2 block text-sm font-medium ">
                  Do you have a voucher or gift card?
                </label>
                <input
                  type="text"
                  id="voucher"
                  class="w-2/3 px-6 py-3.5 outline-none bg-base rounded-[46px] text-[#999999] text-base font-normal leading-normal"
                  placeholder=""
                  required
                />
              </div>
              <button
                type="submit"
                class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-primary hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 :bg-primary-700 :ring-primary-800"
              >
                Apply Code
              </button>
            </form>
