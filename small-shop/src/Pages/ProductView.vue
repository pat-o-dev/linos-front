...
import ProductCards from "@/components/products/Cards.vue";
...
<template>
  <div v-if="state === 'ready' && product">
    ...
    <div class=" bg-base-200 items-start min-h-screen">
      <div class="flex items-start flex-col lg:flex-row-reverse p-4">
        <div>
